    ...
    callWithJQuery(function($) {
      ...
      $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
        ...
        try {
          ...
          rendererControl.append($("<label>", {"class": "textBold"}).text("Tabellentyp")); // Tablo Çeşidi
          ...
          fn1 = function(attr) {
            ...
            attrElem = $("<li>").addClass("axis_" + i + " border rounded-lg border-dark")
                                .append($("<span>").addClass('pvtAttr').append($("<span>").text(attr)).data("attrName", attr)
          ...
          $("<div>").addClass('pvtVals pvtUiCell form-group col-md-6').append($("<label>", {"class": "textBold"}).text("Tabellenbetrieb")).append(aggregator).appendTo(tr1); // Tablo İşlemi
          
          tr2 = $("<div>", {"id": "tableArea", "class": "px-5 pt-4"}).appendTo(uiTable);
          ...
          tr2.find("div.row:nth-child(1)")
              ...
              .append($("<img>", {"src": "maximize.svg", "type": "button", "data-toggle": "tooltip", "title": "Full Screen"}).css("width", "20px"))
          ...
          tr2.find("div.row:nth-child(1)")
            .append($("<div>")
                ...
                .append($("<button>", {"class": "btn btn-dark btn-sm align-self-center"}).text("Sütun Ekle").attr({"data-whatever": ".pvtCols", "type": "button", "data-toggle": "modal", "data-target": "#modalForVariable"})));
        
          tr2.find("div.row:nth-child(2)")
            .append($("<div>")
                .addClass('pvtAxisContainer pvtRows pvtUiCell border')
                .append($("<button>", {"class": "btn btn-dark btn-sm"}).text("Satır Ekle").attr({"data-whatever": ".pvtRows", "type": "button", "data-toggle": "modal", "data-target": "#modalForVariable"})));
