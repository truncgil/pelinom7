					...
					<tr class="" id="t{{$a->id}}">
                       ...
                       <td class="text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <?php if($a->slug!="") { ?>
                                <a title="{{$a->title}} {{__('içeriğini önizleyin')}}" href="{{ url($a->slug) }}" target="_blank" class="btn btn-secondary js-tooltip-enabled d-none" data-toggle="tooltip" title="" data-original-title="Edit">
                                ...
                                <a href="{{ url('admin/contents/'. $a->id .'/delete') }}" ajax="#t{{$a->id}}" teyit="{{$a->title}} {{__('içeriğini silmek istediğinizden emin misiniz?')}}" title="{{$a->title}} {{__('Silinecek!')}}" class=" btn  btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Delete">
